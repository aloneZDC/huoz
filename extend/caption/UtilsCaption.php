...
class UtilsCaption
{
    public $Width   = 100;      //图片宽
    public $Height   = 50;      //图片高
    public $Length   = 4;      //验证码位数
    public $BgColor  = "#FFFFFF";  //背景色
    public $TFonts = array("hagin.otf");
    public $TFontSize=array(20,20); //字体大小范围
    public $TFontAngle=array(-20,20); //旋转角度
    public $Chars  ="abcdefghijklmnopqrstuvwxyz0123456789";     //验证码范围（字母数字）
    public $Code  = array();       //验证码
    public $Image  = "";       //图形对象
    public $FontColors=array('#f36161','#f36161','#f36161');
        //array('#f36161','#6bc146','#5368bd'); //字体颜色,红绿蓝
    public $TPadden = 0.8;///字符间距,多少个字符
    public $Txbase = 5;///x轴两边距离
    public $Tybase =5 ;///y轴两边距离
    public $TLine =true; ///画干扰线
    public $EnterCode="ABCD";
    ...
    public function Draw() ///画图
    {
        ...
        imagepng( $image,WEB_PATH."/code_img/".$this->EnterCode.".png");
        imagepng( $image);
        imagedestroy($image);
    }
    /**
