      ...
      <div class="scroll">
        <van-tabs v-model="active" @click="tabHandler" swipeable :swipe-threshold="4">
          ...
          <div class="scroll-list" v-if="active == 0">
            ...
            <div class="scroll-list-type">
              <div>
                ...
                <span>累计本人总额度 (火米)</span>
              </div>
              <div>
                <p>{{ allNum }}</p>
                <span>累计团队总额度 (火米)</span>
              </div>
            </div>
            <div class="scroll-list-type">
              <div>
                <p>{{ dataConfig.max_team_total - 0 }}</p>
                <span>大社区累计额度 (火米)</span>
              </div>
              <div>
                <p>{{ dataConfig.team_total - 0 }}</p>
                <span>小社区累计额度 (火米)</span>
              </div>
            </div>
            <div class="scroll-list-type">
              <div>
            ...
            <div class="scroll-list-type">
              <div>
                ...
                <span>大社区累计预充 (火米)</span>
              </div>
              <div>
                <p>{{ dataConfig.min_subscribe - 0 }}</p>
                <span>小社区累计预充 (火米)</span>
              </div>
            </div>
            <div class="scroll-list-type">
              <div>
                  ...
                  <li class="detail" v-for="(item, index) in one" :key="index">
                    <div class="fisrt-type">
                      ...
                      <div class="types-line">
                        ...
                        <span>{{ item.reward }} 收益赠与</span>
                      </div>
                      <div class="types-line">
                        <span>昨日团队自动清算/累计:</span>
                        <span>{{ item.team_reward }} 火米</span>
                      </div>
                      <div class="types-line">
                        <span>昨日此账户自动清算/累计:</span>
                        <span>{{ item.personal_num }} 火米</span>
                      </div>
                      <div class="types-line">
                        <span>昨日团队预充/累计:</span>
                        <span>{{ item.team_subscribe }} 火米</span>
                      </div>
                      <div class="types-line">
                        <span>昨日此账户预充/累计:</span>
                        <span>{{ item.personal_subscribe }} 火米</span>
                      </div>
                      <!-- <div class="types-line">
                        <span>昨日本人收益:</span>
                        <span>{{ item.reward - 0 }} 赠与收益</span>
                      </div>
                      <div class="types-line">
                        <span>昨日本人清算流水:</span>
                        <span>{{ item.personal_reward - 0 }} 赠与收益</span>
                      </div>
                      <div class="types-line">
                        <span>昨日团队清算流水:</span>
                        <span>{{ item.team_reward - 0 }} 赠与收益</span>
                      </div> -->
                      <div class="types-l"></div>
                      <div class="types-line">
                        <span>累计总额度:</span>
                        <span>{{ item.count_num - 0 }} 火米</span>
                      </div>
                      <div class="types-line">
                        <span>累计本人额度:</span>
                        <span>{{ item.total_num - 0 }} 火米</span>
                      </div>
                      <div class="types-line">
                        <span>累计团队额度:</span>
                        <span>{{ item.team_total - 0 }} 火米</span>
                      </div>
                      <!-- <div class="types-line">
                        <span>累计总清算流水:</span>
                        <span>{{ item.total_reward - 0 }} 赠与收益</span>
                      </div>
                      <div class="types-line">
                        <span>累计本人清算流水:</span>
                        <span>{{ item.total_personal_reward - 0 }} 赠与收益</span>
                      </div>
                      <div class="types-line">
                        <span>累计团队清算流水:</span>
                        <span>{{ item.total_team_reward - 0 }} 赠与收益</span>
                      </div> -->
                      <div>
                        <span>加入时间:</span>
          ...
          <div class="scroll-list" v-if="active == 1">
            ...
            <div class="scroll-list-type">
              <div>
                ...
                <span>昨日团队清算流水 (火米)</span>
              </div>
              <div>
                <p>{{ dataConfig.total_today_reward - 0 }}</p>
                <span>累计团队清算流水 (火米)</span>
              </div>
            </div>
            <div class="scroll-list-type scroll-list-type-fire">
              <div>
                <p>{{ dataConfig.n_auto_reward - 0 }}</p>
                <span>新累计管理赠与（赠与收益）</span>
              </div>
            </div>
            <van-divider>记录明细</van-divider>
            <van-pull-refresh
          ...
          <div class="scroll-list" v-if="active == 2">
            ...
            <div class="scroll-list-type scroll-list-type-fire">
              <div>
                <p>{{ dataConfig.n_share_reward - 0 }}</p>
                <span>新累计分享赠与 (赠与收益)</span>
              </div>
            </div>
            <van-divider>记录明细</van-divider>
            <van-pull-refresh
          ...
          <div class="scroll-list" v-if="active == 3">
            ...
            <div class="scroll-list-type scroll-list-type-fire">
              <div>
                <p>{{ dataConfig.n_team_reward - 0 }}</p>
                <span>新累计管理赠与+辅导赠与(赠与收益)</span>
              </div>
            </div>
            <van-divider>记录明细</van-divider>
            <van-pull-refresh
          ...
          <div class="scroll-list" v-if="active == 4">
            <div class="scroll-list-type">
              <div>
                <p>{{ dataConfigTwo.yesterday_centre_reward - 0 }}</p>
                <span>昨日服务赠与 (赠与收益)</span>
              </div>
              <div>
                <p>{{ dataConfigTwo.total_centre_reward - 0 }}</p>
                <span>旧累计服务津贴 (火米)</span>
              </div>
            </div>
            <div class="scroll-list-type scroll-list-type-fire">
              <div>
                <p>{{ dataConfig.n_centre_reward - 0 }}</p>
                <span>新累计服务赠与(赠与收益)</span>
              </div>
            </div>
            <van-divider>记录明细</van-divider>
            <van-pull-refresh
...
<script>
import { my_info, help_log, power_log, buy_info, y_subscribe_info, y_subscribe_help_log, y_subscribe_power_log, y_centre_log } from "@/http/api.js";
export default {
  data () {
    return {
      info: {
  ...
  methods: {
    async _buy_info () {
    await  this.$http.post(buy_info).then(({ data }) => {
        if (data.code == 10000) {
          this.dataConfig = {
            ...data.result,
          };
