                ...
                <ul class="list-wrap">
                  ...
                  >
                    ...
                    <div class="listMain">
                      ...
                      <p>
                        已投燃料:<span>{{ item.money - 0 }} 火米</span>
                      </p>
                      <p v-show="item.status != 0">
                        已退燃料:<span>{{ item.capital - 0 }} 火米</span>
                      </p>
                      <p v-show="item.status == 0">
                        预估预约赠与:<span
                          >{{ item.estimate_statics_reward - 0 }} 赠与收益</span
                        >
                      </p>
                      <p v-show="item.status == 1">
                        已获预约赠与:<span
                          >{{ item.statics_reward - 0 }} 赠与收益</span
                        >
                      </p>
                      <p v-show="item.status == 2">
                        释放金米:<span>{{ item.integral - 0 }} 金米</span>
                      </p>
                      <p>
...
<script>
import { my_advance, sub_cancel } from "@/http/api.js";
  ...
  methods: {
    ...
    fetchList (obj) {
      return new Promise((resolve, reject) => {
        ...
        this.$http.post(my_advance, option).then(({ data }) => {
          if (data.code == 10000) {
