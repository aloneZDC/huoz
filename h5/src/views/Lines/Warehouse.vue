...
<script>
import { rocket_index } from "@/http/api.js";
export default {
  name: "inDetails",
  components: {},
  data() {
  ...
  methods: {
    goNext(_id) {
      let url = "/wareDets" + '?id=' + _id + "&type=" + this.dataOption.type;
      this.$router.push({ path: url });
    },
    onLoad() {
      this.isUpLoading = true;
      this.$http
        .post(rocket_index, this.dataOption)
        .then(({ data }) => {
