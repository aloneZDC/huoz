          ...
          <div class="scroll-list" v-if="active == 2">
            <div class="scroll-list-type">
              <div>
                ...
                <span>昨日服务津贴 (Y令牌)</span>
              </div>
              <div>
                <p>{{ dataConfig.total_centre_reward - 0 }}</p>
                <span>累计服务津贴 (Y令牌)</span>
              </div>
            </div>
            <van-divider>记录明细</van-divider>
            <van-pull-refresh
...
<script>
import { ark_subscribe_info, ark_subscribe_help_log, ark_subscribe_power_log, ark_centre_log } from "@/http/api.js";
export default {
  data () {
    return {
      info: {
