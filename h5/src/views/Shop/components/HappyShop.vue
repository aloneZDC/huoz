  ...
  <div>
    <div class="my-content">
      <div class="scroll-content">
        <van-tabs v-model="happyActive" @click="tabHandler" swipeable>
          <van-tab
            v-for="(tabName, idx) in tabLabels"
            :key="idx"
            :title="tabName.name"
          ></van-tab>
          <div class="my-scroll-list" v-if="happyActive == 0">
            <!-- <van-pull-refresh
          ...
          <div class="my-scroll-list" v-else-if="happyActive == 1">
            <!-- <van-pull-refresh
          ...
          <div class="my-scroll-list" v-else-if="happyActive == 2">
            <!-- <van-pull-refresh
          ...
          <div class="my-scroll-list" v-else-if="happyActive == 3">
            <!-- <van-pull-refresh
          ...
          <div class="my-scroll-list" v-else-if="happyActive == 4">
            <!-- <van-pull-refresh
              v-model="fourDownLoading"
              @refresh="onRefresh('four')"
              success-text="刷新成功"
          ...
          <div class="my-scroll-list" v-else-if="happyActive == 5">
            <!-- <van-pull-refresh
              v-model="fourDownLoading"
              @refresh="onRefresh('four')"
              success-text="刷新成功"
          ...
          <div class="my-scroll-list" v-else-if="happyActive == 6">
            <!-- <van-pull-refresh
              v-model="fourDownLoading"
              @refresh="onRefresh('four')"
              success-text="刷新成功"
          ...
          <div class="my-scroll-list" v-else-if="happyActive == 7">
            <!-- <van-pull-refresh
              v-model="fourDownLoading"
              @refresh="onRefresh('four')"
              success-text="刷新成功"
...
export default {
  ...
  // },
  // watch: {
  //   msgLists(newData, prevData) {
  //     this.tabLabels = newData[1].children;
  //     console.log(this.tabLabels);
  //   },
  // },
  data() {
    return {
      happyActive: Number(localStorage.getItem("activeHappyShopIdx"))
        ? Number(localStorage.getItem("activeHappyShopIdx"))
        : 0,
      tabLabels: [], // 首页专区
  ...
  methods: {
    ...
    tabHandler (idx) {
      this.tabLabels.forEach((item, index) => {
        ...
        if (index == idx) {
          this.happyActive = idx;
          this.onLoad(item.type);
        }
      });
      // 存儲ID
      this.$nextTick(() => {
        localStorage.setItem("activeHappyShopIdx", idx);
      });
    },
    fetchList (obj) {
  ...
  created() {
    this.tabLabels = this.msgLists[0].children;
    this.tabLabels.forEach((item, index) => {
      switch (index) {
        case 0:
