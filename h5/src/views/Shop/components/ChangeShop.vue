<template>
  <div>
    <div class="my-content">
      <div class="scroll-content csroll-content-change">
        <van-tabs v-model="changeActive" @click="tabHandler" swipeable>
          <van-tab
            v-for="(tabName, idx) in tabLabels"
            :key="idx"
            :title="tabName.name"
          ></van-tab>
          <div class="my-scroll-list" v-if="changeActive == 0">
            <!-- <van-pull-refresh
              ...
              >
                ...
                <div class="warpBox">
                  ...
                  >
                    ...
                    <div class="price pd">
                      <p class="now">{{ (item.goods_price / item.hm_price).toFixed(4) }}<span>金米</span></p>
                      <!-- <p class="num">爆提{{ item.goods_sale_number }}件</p> -->
                    </div>
                    <!-- <div class="price_mi">
                      <div>赠与≈</div>
                      <div></div>
                      <div>{{ parseInt(item.goods_currency_give_num * item.hm_price) }}<span>&nbsp;积分</span></div>
                    </div> -->
                  </div>
                </div>
              </van-list>
          ...
          <div class="my-scroll-list" v-else-if="changeActive == 1">
            <!-- <van-pull-refresh
          ...
          <div class="my-scroll-list" v-else-if="changeActive == 2">
            <!-- <van-pull-refresh
          ...
          <div class="my-scroll-list" v-else-if="changeActive == 3">
            <!-- <van-pull-refresh
          ...
          <div class="my-scroll-list" v-else-if="changeActive == 4">
            <!-- <van-pull-refresh
              v-model="fourDownLoading"
              @refresh="onRefresh('four')"
              success-text="刷新成功"
          ...
          <div class="my-scroll-list" v-else-if="changeActive == 5">
            <!-- <van-pull-refresh
              v-model="fourDownLoading"
              @refresh="onRefresh('four')"
              success-text="刷新成功"
          ...
          <div class="my-scroll-list" v-else-if="changeActive == 6">
            <!-- <van-pull-refresh
              v-model="fourDownLoading"
              @refresh="onRefresh('four')"
              success-text="刷新成功"
          ...
          <div class="my-scroll-list" v-else-if="changeActive == 7">
            <!-- <van-pull-refresh
              v-model="fourDownLoading"
              @refresh="onRefresh('four')"
              success-text="刷新成功"
...
export default {
  ...
  data() {
    return {
      changeActive: Number(localStorage.getItem("activeChangeShopIdx"))
        ? Number(localStorage.getItem("activeChangeShopIdx"))
        : 0,
      tabLabels: [], // 首页专区
  ...
  methods: {
    ...
    tabHandler (idx) {
      ...
      // 存儲ID
      this.$nextTick(() => {
        localStorage.setItem("activeChangeShopIdx", idx);
      });
    },
    fetchList (obj) {
  ...
  created() {
    this.tabLabels = this.msgLists[2].children;
    this.tabLabels.forEach((item, index) => {
      switch (index) {
        case 0:
