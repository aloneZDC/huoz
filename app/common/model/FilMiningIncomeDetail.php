...
class FilMiningIncomeDetail extends Base
{
    static function award($member_id,$currency_id,$award_num,$base_id,$base_num,$release_id,$base_percent,$today_start,$third_member_id) {
        //添加奖励记录
