...
class Trade extends Admin {
    ...
    public function trade(Request $request){
        ...
        $field = "a.*,b.currency_name as b_name,d.currency_name as b_trade_name,c.email as email,c.member_id as member_id,c.name as name,c.phone as phone";
...
//            $where .= " and a.member_id = '{$member_id}'";
        ...
        $this->assign("member_id", $member_id);
        $field = "a.*,b.currency_name as b_name,d.currency_name as b_trade_name,c.email,c.name,c.phone";
...
//            $where .= " and a.member_id = '{$member_id}'";
    ...
    public function rebot_config()
    {
        ...
        /*$configSelect = OrdersRebotConfig::select();
        $configList = [];
     ...
     * 机器人配置-更新
     */
    public function updateRebotCofig(Request $request)
    {
