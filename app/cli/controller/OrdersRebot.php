 ...
 * 挂单机器人
 */
class OrdersRebot extends Command
{
    protected $configs = [];
    ...
    {
        $this->setName('OrdersRebot')->setDescription('This is a OrdersRebot task');
    }
    ...
    protected function init_configs($trade)
    {
        ...
        $this->configs = $trade;
        $this->currency = null;
        $this->currency = Currency::get($trade['currency_id']);
        $this->currency_trade = null;
        $this->currency_trade = Currency::get($trade['trade_currency_id']);
