...
ss += '#alertBtn:hover{color: #D85054;} #alertText{font-size:20p;font-weight:bold;color:#333;} #alertWin p{padding:10px 10px 15px 10px;text-align:center;} #alertBg{position: fixed; top: 0%; left: 0%; width: 100%; height: 100%; background-color: #eee; z-index:100000; -moz-opacity: 1; opacity:1; filter: alpha(opacity=100);}';
ss += '</style>';
